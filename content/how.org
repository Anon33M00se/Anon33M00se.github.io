...
The whole site is managed by editing local files in Emacs and then a
couple of quick keystrokes push out any changes to a free web-hosting
github. I'll explain each of the pieces in turn.
...
end of this document where you can find more details on all the
...
host it at github, we need a couple of more pieces in places.

The first step is get a github account. Even if you already have an
...
Once you've got the github account setup, it's most straightforward to
go ahead and create a repository in your account that consists of your username plus "gihub.io", like this:
