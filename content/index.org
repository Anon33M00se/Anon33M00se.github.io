...
# #+END_aside
# 
# And here is some slightly more complicated math:
# 
...
- [[https://muna.ai][Running AI models anywhere (including local devices)]]
- [[https://ethicalairesearch.com/][Machine Learning in Engineering]]
- [[./pta.org][Plain Text Accounting]]
- [[https://floathub.com][FloatHub]] ([[https://github.com/floathub/device][github repo]])
...
- [[https://patents.google.com/patent/US9605926][DuckDrone]] (simulated duck hunting with drones)
...
- Automation controllers with [[https://www.linux.com/news/linux-perks-espresso-book-machine/][Linux]] 
...
- Inflation and Uncertainty ([[https://books.google.com/books/about/Inflation_Uncertainty_and_Financial_Inte.html?id=mlslQwAACAAJ][here]] and [[https://www.mcgill.ca/economics/files/economics/a_framework_for_examining_the_real_effects_of_inflation_volatility.pdf][here]])
...
Send an email to: feedback --at-- sigvaldason.com
